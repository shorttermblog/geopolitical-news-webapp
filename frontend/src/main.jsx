        ...
        <section className="grid gap-4 xl:grid-cols-[minmax(0,1.08fr)_minmax(560px,1fr)] 2xl:grid-cols-[minmax(0,1fr)_minmax(700px,1fr)]">
          <div className="panel p-4">
            <div className="mb-3 flex items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-lg font-semibold tracking-tight text-slate-950">Ranked Articles</h2>
                  <p className="text-xs font-medium text-slate-500">Click a title to open the source.</p>
                </div>
              </div>
                ...
                <table className="w-full table-fixed border-collapse text-left text-[13px]">
                  ...
                  <tbody className="divide-y divide-slate-100 bg-white">
                    ...
                    {articles.map((row, idx) => (
                      <tr key={`${row.link}-${idx}`} className="align-top transition hover:bg-slate-50">
                        <td className="px-3 py-4 font-semibold text-slate-950">{row.rank}</td>
                        <td className="px-3 py-4 tabular-nums text-slate-600">{Number(row.score || 0).toFixed(3)}</td>
                        ...
                        <td className="break-words px-3 py-4 text-slate-600">{row.source}</td>
                        <td className="break-words px-3 py-4 text-slate-500">{row.published}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          <div className="briefing-card">
            <div className="mb-3 flex items-center gap-2">
              ...
              <div>
                <h2 className="text-lg font-semibold tracking-tight text-white">AI Briefing</h2>
                <p className="text-xs font-medium text-slate-400">Generated from ranked RSS metadata.</p>
              </div>
            </div>
